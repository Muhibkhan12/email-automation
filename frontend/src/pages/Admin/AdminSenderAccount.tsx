...
const AdminSenderAccounts = () => {
  ...
  const getProviderBadge = (provider: SenderProvider) => {
    ...
    return (
      <span
        className={`inline-flex items-center justify-center rounded-full px-2.5 py-1 text-xs font-medium ${config.bg} ${config.text}`}
      >
        {config.icon}
      </span>
    );
      ...
      <main className="main-content flex-1 overflow-y-auto p-4 md:p-6 lg:p-8 bg-[#0E1013] h-screen">
        ...
        <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg bg-[#FF6A39] px-4 py-2.5 text-sm font-medium text-white shadow-lg shadow-[#FF6A39]/20 hover:bg-[#e85a2c] transition"
          >
            <Plus size={16} />
            Add Sender Account
          </button>
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
          <div className="flex flex-wrap items-center gap-3">
            ...
            {selectedAccounts.size > 0 && (
              <span className="text-xs text-[#8B8D94]">{selectedAccounts.size} selected</span>
            )}
          </div>

          <div className="flex items-center gap-3">
            <button className="flex items-center gap-2 rounded-lg border border-[#2A2E37] bg-[#171A21] px-3 py-2 text-xs font-medium text-[#C7C9CE] hover:border-[#3A3F4A] transition">
              <RefreshCw size={12} />
              Refresh
            </button>
            <button className="flex items-center gap-2 rounded-lg border border-[#2A2E37] bg-[#171A21] px-3 py-2 text-xs font-medium text-[#C7C9CE] hover:border-[#3A3F4A] transition">
            ...
            <table className="w-full text-left min-w-[1200px]">
              <thead className="text-[10px] md:text-[11px] uppercase tracking-wide text-[#8B8D94] border-b border-[#2A2E37] bg-[#0E1013]">
                <tr>
                  ...
                  <th className="px-3 py-3 font-medium">Daily Usage</th>
                  <th className="px-3 py-3 font-medium">Hourly Usage</th>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-3 py-3.5">
                        <div className="flex items-center gap-3">
                          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#FF6A39]/10 text-[#FF6A39] text-xs font-semibold">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] md:text-[11px] text-[#8B8D94]">{account.email}</p>
                          </div>
                        </div>
                      </td>
                      <td className="px-3 py-3.5">
                      ...
                      <td className="px-3 py-3.5">
                        <div>
                          <p className="text-[11px] md:text-[13px] text-[#C7C9CE] font-['JetBrains_Mono']">
                            {account.totalSent.toLocaleString()}
                          </p>
                          <p className="text-[9px] text-[#8B8D94]">
                  ...
                  <tr>
                    <td colSpan={9} className="px-5 py-16 text-center">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-sm text-[#8B8D94]">No sender accounts found</p>
            ...
            <div className="w-full max-w-2xl rounded-2xl bg-[#171A21] border border-[#2A2E37] shadow-2xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6 space-y-5">
                ...
                {formData.provider === "Custom SMTP" && (
                  <div className="space-y-4 rounded-lg border border-[#2A2E37] bg-[#0E1013] p-4">
                    <h4 className="text-sm font-medium text-[#E8E6E1]">SMTP Configuration</h4>
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <div>
                        <label className="mb-2 block text-sm font-medium text-[#C7C9CE]">
                          SMTP Host
                ...
                {editingAccount && (
                  <div className="rounded-lg border border-[#2A2E37] bg-[#0E1013] p-4">
                    <h4 className="text-sm font-medium text-[#E8E6E1]">Account Statistics</h4>
              ...
              <div className="flex flex-wrap justify-end gap-3 border-t border-[#2A2E37] p-6">
                <button
                  onClick={() => setShowModal(false)}
                ...
                <button
                  ...
                  className="flex items-center gap-2 rounded-lg bg-[#FF6A39] px-5 py-2.5 text-sm font-medium text-white hover:bg-[#e85a2c] transition"
                >
                  <Save size={16} />
